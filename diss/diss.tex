...
\end{adjustbox}
\footnotetext[1]{This word count was computed by \texttt{texcount -inc -sum -1 diss.tex}. It includes all body text, headings, footnotes and captions.}
\footnotetext[2]{Line count is the count of OCaml code excluding comments and blank lines. Also excluded are all testing scripts.}
